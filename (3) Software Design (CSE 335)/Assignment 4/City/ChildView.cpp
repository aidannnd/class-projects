...
/**
* Menu handler to set the option to be checked or not checked
* \param pCmdUI Helper class object for the menu
*/
...
/** Menu handler that runs when the menu option is clicked */
...
{
    pCmdUI->SetCheck(mTeleportOn);
}

/** Menu handler that runs when the menu option is clicked */
void CChildView::OnTransporterTransport()
{
    mTeleportOn = !mTeleportOn;
}

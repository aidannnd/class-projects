...
class Pawn {
    ...
    public function setCurrentNode($node, $swapping = false) {
        if(!$swapping && $this->current_space->getOccupied() && $this->current_space->getOccupiedPiece()->getOwner() == $this->owner) {
        ...
        if($this->home_tile->getCoordinates() === $this->current_space->getCoordinates()){
            $this->home = true;
            $this->protected = true;
        }
    }

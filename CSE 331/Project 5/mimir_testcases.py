...
class TestProject1(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        # avl3.insert(avl3.root, 11)
        # avl3.insert(avl3.root, 20)
        # avl3.insert(avl3.root, 7)
        # avl3.insert(avl3.root, 10)
        # avl3.insert(avl3.root, 12)
        # avl3.insert(avl3.root, 13)
    ...
    # def test_search(self):
        ...
        # avl2 = AVLTree()
        # avl2.insert(avl2.root, 30)

        # print(avl2.search(avl2.root, 20))
    ...
    # def test_set_and_replace_child(self):
